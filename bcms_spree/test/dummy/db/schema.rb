...
ActiveRecord::Schema.define(version: 20140911225425) do

  create_table "bcms_spree_product_versions", force: true do |t|
    t.string   "name"
    t.integer  "price"
    t.text     "description"
  ...
  create_table "bcms_spree_products", force: true do |t|
    t.string   "name"
    t.integer  "price"
    t.text     "description"
    t.datetime "created_at"
